...
def ensure_toolbitshape_assets_initialized(asset_manager: AssetManager, store_name: str = "local"):
    ...
    shape_path = Preferences.getAssetPath() / "Tool" / "Shape"
...
asset_mapping = {
    "toolbitlibrary": "Tool/Library/{asset_id}.fctl",
    "toolbit": "Tool/Bit/{asset_id}.fctb",
    "toolbitshape": "Tool/Shape/{asset_id}.fcstd",
    "toolbitshapesvg": "Tool/Shape/{asset_id}",  # Asset ID has ".svg" included
    "toolbitshapepng": "Tool/Shape/{asset_id}",  # Asset ID has ".png" included
